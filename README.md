...
``` HTML
<link rel="stylesheet" href="//cdn.jsdelivr.net/npm/slippery@1.0.1/dist/css/slippery.min.css">
```

Also needed inclusion Javascript before closing <body> tag.
``` HTML
<script src="//cdn.jsdelivr.net/npm/slippery@1.0.1/dist/js/slippery.min.js"></script>
```
